...
public interface UserRepository extends JpaRepository<User, String> {
    ...
    @Query("SELECT new group17.HospitalWardManagementSystem.Model.Dto.StaffDto.ShowStaffDto(A.nic,A.fullName,A.mobileNo,A.email, A.Position)  FROM User A INNER JOIN Staff B ON B.nic=A.nic WHERE B.wardNo=:wardNo ANd A.Position='Nurse'")
