...
public class TemporyDumyDataAddingService {
    ...
    public void addSisterData(){
        ...
        sisters.add(User.builder().nic("198602060707").fullName("T K R Perera").firstName("Tharaka").lastName("Perera").username("user26").password(passwordEncoder.encode("password26")).dob(LocalDate.parse("1977-06-15")).email("edirisinhageheshan@gmail.com").Position(UserRole.Sister).mobileNo("234-567-8901").build());
